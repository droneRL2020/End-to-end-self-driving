...
Serial.print("F",UltraSensorF); //data that is being Sent
//Serial.println(" cm");
//Serial.print("Front distance to obstacle in RIGHT: ");    //data that is being Sent
Serial.print("R",UltraSensorR); //data that is being Sent
//Serial.println(" cm");
//Serial.print("Front distance to obstacle in LEFT: ");    //data that is being Sent
Serial.print("L",UltraSensorL); //data that is being Sent
//Serial.println(" cm");
